...
var MessengerView = /** @class */ (function () {
    function MessengerView() {
        ...
        this.getUserBox = function (name, surname) {
        ...
        this.getDialogue = function (color, name, surname, messageStr, unread) {
        ...
        this.getRelationBox = function (userID, partnerID, isAlreadyPinned) {
            var box = document.createElement("div");
